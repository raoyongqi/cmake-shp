...
plt.legend(handles=legend_patches, title='Column 10 Values', loc='lower right', fontsize=10, title_fontsize=10, borderpad=1, handletextpad=1.5,bbox_to_anchor=(1, 0.6))
