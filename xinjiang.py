...
# 从本地读取 GeoJSON 文件
with open('新疆维吾尔自治区.json', 'r', encoding='utf-8') as file:
...
ax.set_extent([70, 100, 35, 50], crs=ccrs.PlateCarree())
shp_file_path = 'shp/新疆维吾尔自治区.shp'
...
inset_border = Rectangle(
    (0.25, 0.6),  # left and bottom position of the inset (matching the inset position)
...
ax_china_inset = fig.add_axes([0.26, 0.6, 0.15, 0.3], projection=equal_area_crs)  # [left, bottom, width, height]
